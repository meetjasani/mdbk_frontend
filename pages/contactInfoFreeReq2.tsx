...
function ContactInfoFreeReqSec() {
                        ...
                        <Form name="requestinfo" layout="vertical" onFinish={(values) => { console.log(values) }}>
                                ...
                                <div className="dropdown" style={{ float: "left", color: "white", width: "100%", marginTop: "40px" }}>
                                    <Form.Item
                                        ...
                                        <Dropdown overlay={() => (<Menu>
                                            ...
                                            <Button className={stylesthird.dropdownBtn} style={{ height: "64px", borderRadius: "20px", width: "100%" }}>자주쓰는 메시지 불러오기 <img src="/arrowdown.svg" style={{ float: "right", paddingTop: "10px" }} /></Button>
                                        </Dropdown>
                                    </Form.Item>
                                </div>
                            </div>
                            ...
                            <div className="p-form-cmn" style={{ width: "100%", float: "left", paddingBottom: "30px", marginTop: "50px" }}>
                                <div className="d-flex justify-content-center" >
                                    ...
                                    <Button className={styles.lstbluebtn} style={{ width: "50%" }} >
                                        매일 무료 1회(총2회) 연락처 요청
                                    </Button>
                                </div>
                            </div>
...
export default ContactInfoFreeReqSec