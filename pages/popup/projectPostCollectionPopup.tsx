...
function ProjectPostCollectionPopup() {
  ...
  return (
    <Modal
      ...
      title={
        <div>
          ...
          >
            {t("projectPostcollectionPopup.title")}
          </p>
        </div>
      }
      centered
    ...
    >
      <p> {t("projectPostcollectionPopup.description")}</p>
    </Modal>
  );
}
...
export default ProjectPostCollectionPopup;
