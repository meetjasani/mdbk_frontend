...
function ProjectEditingCompletePop() {
  ...
  return (
    <Modal
      ...
      title={
        <div>
          ...
          >
            {t("projectEditingCompletePopup.title")}
          </p>
        </div>
      }
      centered
    ...
    >
      <p> {t("projectEditingCompletePopup.description")}</p>
    </Modal>
  );
}
...
export default ProjectEditingCompletePop;
