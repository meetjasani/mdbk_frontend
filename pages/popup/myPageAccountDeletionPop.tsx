...
function MyPageAccountDeletionPop() {
  ...
  return (
    ...
    >
      <p> {t("myPageAccountDeletion.subTitle")}</p>
      <p> {t("myPageAccountDeletion.subTitle1")}</p>
    </Modal>
  );
}
...
export default MyPageAccountDeletionPop;
