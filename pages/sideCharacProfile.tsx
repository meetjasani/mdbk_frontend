            ...
            <div className="clientprofile-2  mainContainercmn">
                ...
                <div className="cmn-profile-section col4-cmn-cntr-800 box-section">
                    ...
                    {/* <div className={stylessec.flw} style={{ paddingTop: "20px" }}>
                            ...
                            {detailedVisible && (<>
                                <div className={stylessec.flw} style={{ paddingTop: "20px" }}>
                                    <img src="/g4.svg" style={{ width: "33%" }} />
                                    <img src="/g5.svg" style={{ width: "33%", paddingLeft: "5px" }} />
                                    <img src="/g6.svg" style={{ width: "33%", paddingLeft: "5px" }} />
                                </div>
                                <div className={stylessec.flw} style={{ paddingTop: "20px" }}>
                                    <img src="/g7.svg" style={{ width: "33%" }} />
                                    <img src="/g8.svg" style={{ width: "33%", paddingLeft: "5px" }} />
                                    <img src="/g9.svg" style={{ width: "33%", paddingLeft: "5px" }} />
                                </div>
                            </>)} */}
                    {/* </div>
