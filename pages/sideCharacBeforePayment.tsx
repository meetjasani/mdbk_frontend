                    ...
                    <div className={`${stylesforth.userprofilesectop}`} style={{ padding: "30px 30px 30px 30px" }}>
                        <div className="cmn-profile-img mt-4">
                            ...
                            <div className={`d-flex justify-content-center align-items-center`} style={{ paddingTop: "10px" }}>
                                ...
                                <span>
                                    <img src="/grayheart.svg" className={styles.heartimg} alt="Heart Icon" />
                                </span>
                        ...
                        <div className={`${stylesforth.p} d-flex justify-content-center align-items-center`}> 안녕하세요. 개발을 매우 좋아하고 사랑하는 개발왕입니다. 개발한지는 10년이 넘었고 좋아
                            <br /> 하는 일을 하고 있습니다. 함께 즐거운 프로젝트를 할 분을 찾고 있으니 언제든 연락주세요</div>
                    ...
                    <div className="blue-profile-btm with-no-shadow pt-0">
                        <div className="profrate-inner">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 alnright proinr-right proinr-cmn">010- <StarOutlined /><StarOutlined /><StarOutlined />
                                    - <StarOutlined /><StarOutlined /><StarOutlined /><StarOutlined /></div>
                            </div>
                            <div className="row">
                        ...
                        <div className="profrate-inner mb-4 pt-2">
                            <Button className={stylesforth.lstbtn} style={{ backgroundColor: "#00D6E3", color: "white", width: "60%" }}>더보기</Button>
                        </div>
                        ...
                        <div className={stylessec.flw} style={{ boxSizing: "border-box", padding: "10px 10px 10px 10px" }}>
                            ...
                            <div className={stylessec.flw} >
                                ...
                                <span className={stylesforth.labelright}>
                                    <img src="/star.svg" alt="Heart Icon" />
                                </span>
                            </div>
                            <div className={stylessec.flw}>
                                <span className={`${stylessec.modaltxt} ${stylesforth.label}`}>
