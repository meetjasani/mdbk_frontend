...
import { Header, Giftbox, ProfileSearchCard, BannerBoxConatinerSec } from '../../../components'
        ...
        <div className="jumbotron">
                        ...
                        <div className={`${styles.pt40}`}>
                            ...
                            <div className="row" style={{ width: "100%", paddingTop: "30px" }}>
                                ...
                                <div className={`${stylessec.pt30} row`}>
                                    ...
                                    <div className="row " style={{ width: "100%", paddingTop: "10px" }}>
                                        <Radio.Group defaultValue="3" className="span-radio">
                                            <Radio.Button value="1" className={`${stylessec.bigbtn} span-radio`} style={{ borderTopLeftRadius: "10px", borderBottomLeftRadius: "10px" }}>
                                                <span className={`${stylessec.firsttext} `}>단기 프로젝트</span> <br />
                                                <span className={`${stylessec.sectext}`}>
                                                    3개월 미만</span></Radio.Button>

                                            <Radio.Button value="3" className={`span-radio ${stylessec.bigbtn}`} style={{ borderBottomRightRadius: "10px", borderTopRightRadius: "10px" }}>
                                                <span className={`${stylessec.firsttext}`}>단기 프로젝트</span> <br />
                                                <span className={`${stylessec.sectext}`}>
                                                    3개월 미만</span></Radio.Button>
                                        </Radio.Group>
            ...
            <div className="h-100 pb-5">
                {!detailedVisible && (<div className="col4-cmn-cntr-800">
                    {activeTab === 0 && profiles.profiles.map((profile, index) => <ProfileSearchCard key={index} profile={profile} />)}
                    ...
                    {activeTab === 4 && profiles.profiles.map((profile, index) => <ProfileSearchCard key={index} profile={profile} />)}
                </div>)}
            </div>
        </div >
    )
