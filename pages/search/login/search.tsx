...
import { Giftbox, ProfileSearchCard, BannerBoxConatinerSec } from '../../../components'
import { Menu, Dropdown, Button, Tabs, Divider, Radio, Form, Input, Select } from 'antd';
import styles from '../../../styles/Search.module.css'
import stylessec from '../../../styles/searchdetail.module.css';
import profiles from '../../../public/data'
import { getClientByMemberId, getClientByProfession } from '../../../redux/actions/client/clientAction'
...
function Home() {
    ...
    const clientByProfessionList = useSelector((state: State) => state.client.clientByProfession)
    console.log("clientByProfessionList", clientByProfessionList)
    ...
    const onChange = (value: any) => {
        dispatch(getClientByProfession(value))
        ...
        <div className="jumbotron">
                    ...
                    <div className="row pt-5 pb-5 d-flex justify-content-center">
                        ...
                        <div className="col-6">
                            <div className="dropdown" style={{ float: "right" }}>
                                <Select defaultValue="development" className={styles.dropdownitem} style={{ width: 170 }} onChange={onChange}>
            ...
            <div className="h-100 pb-5">
                {!detailedVisible && (<div className="col4-cmn-cntr-800">
                    {activeTab === 1 && clientByProfessionList.map((profile: any, index: any) => <ProfileSearchCard key={index} profile={profile} />)}
